...
describe("Modal", () => {
    ...
    it("does not render when closed", () => {
        render(<Modal open={false} onClose={() => { }} title="Closed Modal">
    ...
    it("calls onClose when close button is clicked", () => {
        ...
        render(<Modal open={true} onClose={onClose} title="Closable Modal">
        <div>Content</div>
      </Modal>);
    ...
    it("applies size variant", () => {
        render(<Modal open={true} onClose={() => { }} size="lg" title="Large Modal">
